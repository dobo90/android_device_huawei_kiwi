...
# Lines needed for prebuilt kernel:
TARGET_KERNEL_SOURCE := # to make it work on pure cm13 tree
TARGET_PREBUILT_KERNEL := device/huawei/kiwi/kernel
BOARD_MKBOOTIMG_ARGS := --dt device/huawei/kiwi/dt.img
# Uncomment lines below in order to compile kernel from source:
